<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('manajemen_kas*') ? 'active' : '' }}" href="{{ route('manajemen_kas') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-money-check-dollar text-success text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1 mt-1">Manajemen KAS</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('events') ? 'active' : '' }}" href="{{ route('events') }}">
                    ...
                    <span class="nav-link-text ms-1 mt-1">Events</span>
                </a>
            </li>
            <li class="nav-item">
